...
async def main():
    client = OpenArchiveMeteoClient("https://archive-api.open-meteo.com")
    data = await client.get_archive_data(1.23, 4.56, datetime.date(2024,1,25), datetime.date(2024,1,30) )
    print(data)
